      ...
      <div className={styles.mainCradWrapper}>
        <div className={styles.outerWrapper}>
          ...
          <div className={styles.description}>
            <p>
              Handle yearly obligations with automated financial tools and
              timely tax filings
            </p>
          </div>
          ...
          <div className={styles.serviceList}>
            ...
            <ul>
              <li>
                Free & complete company formation and EIN, plus bank account
                application support
              </li>
              <li>
                Professional registered agent, business address with
                mail-forwarding (3 scans/year)
              </li>
              <li>
                Core financial tools for transaction tracking, customizable
                invoicing and online payments
              </li>
              <li>Year-around compliance reminders</li>
              <li>
                <strong>Bonus: </strong> save <strong>50%</strong>
                on BOI filing!
              </li>
            </ul>
          </div>
